    ...
    historyPtr(0)
{
    ...
    ui->notice->setText("For more information on these commands, see the <a href='http://xpy.wiki/index.php?title=MonedaDelEmprendimiento_client/API_calls_list'>Wiki</a>");
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, tr("Welcome to the MonedaDelEmprendimiento RPC console.<br>"
