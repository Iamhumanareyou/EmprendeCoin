...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "MonedaDelEmprendimiento " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
// testnet dns seed begins with 't', all else are MonedaDelEmprendimiento dns seeds.
static const char *strDNSSeed[][2] = {
    {"dnsseed.MonedaDelEmprendimiento.com", "dnsseed.MonedaDelEmprendimiento.com"},
    {"dnsseed.MonedaDelEmprendimientofoundation.org", "dnsseed.MonedaDelEmprendimientofoundation.org"},
    {"dnsseed.xpydev.org", "dnsseed.xpydev.org"},
    {"tseed.MonedaDelEmprendimiento.com", "tseed.MonedaDelEmprendimiento.com"}
};
...
// MonedaDelEmprendimiento: stake minter thread
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer.  MonedaDelEmprendimiento is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    // MonedaDelEmprendimiento: mint proof-of-stake blocks in the background
