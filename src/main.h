...
public:
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // MonedaDelEmprendimiento: get transaction coin age
...
public:
    ...
    // MonedaDelEmprendimiento: block signature - signed by coin base txout[0]'s owner
    ...
    // MonedaDelEmprendimiento: two types of block: proof-of-work or proof-of-stake
    ...
    // MonedaDelEmprendimiento: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // MonedaDelEmprendimiento: calculate total coin age spent in block
    bool SignBlock(const CKeyStore& keystore);
    bool CheckBlockSignature() const;
    unsigned int GetStakeEntropyBit() const; // MonedaDelEmprendimiento: entropy bit for stake modifier if chosen by modifier
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // MonedaDelEmprendimiento: trust score of block chain
    int nHeight;
    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // MonedaDelEmprendimiento: block index flags
    enum
    {
