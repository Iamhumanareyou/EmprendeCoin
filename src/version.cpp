...
// for both MonedaDelEmprendimientod and MonedaDelEmprendimiento(-qt), to make it harder for attackers to
// target servers or GUI users specifically.

// For the current run of MonedaDelEmprendimiento releases, the client name should be selected from
