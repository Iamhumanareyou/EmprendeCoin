TEMPLATE = app
TARGET = MonedaDelEmprendimiento-qt
VERSION = 0.3.2.0
...
TRANSLATIONS = $$files(src/qt/locale/MonedaDelEmprendimiento_*.ts)
...
macx:ICON = src/qt/res/icons/MonedaDelEmprendimiento.icns
macx:TARGET = "MonedaDelEmprendimiento"
