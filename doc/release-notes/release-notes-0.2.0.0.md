MonedaDelEmprendimiento version 0.2.0.0 is now available from:
...
MonedaDelEmprendimiento data directory (listed below) and delete everything except the
wallet.dat and MonedaDelEmprendimiento.conf

Linux : ~/.MonedaDelEmprendimiento/

Windows : %appdata%\Roaming\MonedaDelEmprendimiento
...
- `62a3da1` Update GitHub URLs to point to MonedaDelEmprendimientoFoundation/MonedaDelEmprendimiento
...
- `19ca0ef` Point GitHub URL to MonedaDelEmprendimientoFoundation
...
- Mitchell Cash
- Nathan Bass
- MonedaDelEmprendimiento Developer Team
