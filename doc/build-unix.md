...
Note: Currently, there is no MonedaDelEmprendimiento ebuild available in overlay
...
Take the following steps to build (no UPnP support):
 ...
 strip MonedaDelEmprendimientod


Notes
-----
The release is built with GCC and then "strip MonedaDelEmprendimientod" to strip the debug
